...
<head>
    ...
    <script type="text/javascript">
		var tab_init = {
			'#ijulia': {'status': true},
			'#editor': {'status': false, 'content': '<iframe src="/hosteditor/?email=juser@juliabox.org:dummy" id="editor-frame" frameborder="0" height="100%" width="100%"></iframe>'},
...
<body>
    ...
    <div class="tab-content modules">    	
        ...
        <div id="editor" class="tab-pane content-pad"></div>
